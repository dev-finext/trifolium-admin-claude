...
export const DEMO_ACTORS = {
    ...
    oritSupport: L('אורית ד׳ (תמיכה)', 'Orit D. (support)'),
    nirSupport: L('ניר ק׳ (תמיכה)', 'Nir K. (support)'),
    ellaSupport: L('אלה ש׳ (תמיכה)', 'Ella S. (support)'),
    amitLab: L('עמית ר׳ (מעבדה)', 'Amit R. (lab)'),
    amitPharmacist: L('עמית ר׳ (רוקח)', 'Amit R. (pharmacist)'),
    hadarPharmacist: L('הדר מ׳ (רוקחת)', 'Hadar M. (pharmacist)'),
    orit: L('אורית דגן', 'Orit Dagan'),
    amit: L('עמית רוזן', 'Amit Rosen'),
    nir: L('ניר קפלן', 'Nir Kaplan'),
    ella: L('אלה שגב', 'Ella Segev'),
    hadarMizrahi: L('הדר מזרחי (רוקחת)', 'Hadar Mizrahi (pharmacist)'),
    practitionerRole: L('המטפל', 'The practitioner'),
};

/** Support agents a status change can be attributed to. */
export const SUPPORT_ACTORS = [
    DEMO_ACTORS.oritSupport,
    DEMO_ACTORS.amitLab,
    DEMO_ACTORS.nirSupport,
];

/** Pharmacists who sign off a compounded formula. */
export const PHARMACIST_ACTORS = [
    DEMO_ACTORS.amitPharmacist,
    DEMO_ACTORS.hadarPharmacist,
];
...
const STREET = {
    bengurion: L('בן גוריון', 'Ben Gurion'),
    allenby: L('אלנבי', 'Allenby'),
    gilboa: L('הגלבוע', 'HaGilboa'),
    teena: L('התאנה', 'HaTe’ena'),
    zeitim: L('הזיתים', 'HaZeitim'),
    dekel: L('הדקל', 'HaDekel'),
    hadas: L('ההדס', 'HaHadas'),
    carmel: L('הכרמל', 'HaCarmel'),
    ahadHaam: L('אחד העם', 'Ahad Ha’am'),
    rothschild: L('רוטשילד', 'Rothschild'),
    palmach: L('הפלמ״ח', 'HaPalmach'),
    jerusalemBlvd: L('שדרות ירושלים', 'Jerusalem Blvd'),
    gefen: L('הגפן', 'HaGefen'),
    ela: L('האלה', 'HaEla'),
};
...
const PRACTITIONERS = [
    {
        ...
        therapy: 'naturopathy',
        spec: SPEC.women,
        clinic: L('קליניקת מעיין · רמת גן', 'Maayan Clinic · Ramat Gan'),
        city: CITY.ramatGan,
        phone: '052-000-4546',
        email: 'vered@maayan.example',
        status: 'active',
        points: 1240,
        disc: 40,
        orders: 148,
        ...
        accountingEmail: 'hanhala@maayan.example',
        bizNum: '815382910',
        payMethod: 'transfer',
        shelfDisc: 40,
    },
    {
        ...
        spec: SPEC.pain,
        clinic: L('מרפאת שביל · תל אביב', 'Shvil Clinic · Tel Aviv'),
        city: CITY.telAviv,
        phone: '054-000-2207',
        email: 'matan.halevi@mail.example',
        status: 'active',
        points: 380,
        disc: 40,
        orders: 96,
    ...
    },
    {
        ...
        therapy: 'herbalism',
        spec: SPEC.digestive,
        clinic: L('עלה ושורש · חיפה', 'Leaf & Root · Haifa'),
        city: CITY.haifa,
        phone: '050-000-9014',
        email: 'sigal@ale.example',
        status: 'active',
        points: 2870,
        disc: 25,
        orders: 311,
        ...
        tz: '945612378',
        // V2 — accounting & payment
        accountingEmail: 'billing@kaspi-books.example',
        bizNum: '814029384',
        payMethod: 'transfer',
        shelfDisc: 35,
    },
    {
        ...
        city: CITY.modiin,
        phone: '053-000-0982',
        email: 'nadav.kaspi@mail.example',
        status: 'active',
        points: 90,
        disc: 40,
        orders: 24,
    ...
    {
        code: '11588',
        first: L('אביגיל', 'Avigail'),
        last: L('צדוק', 'Tzadok'),
        therapy: 'chinese_medicine',
        spec: SPEC.menopause,
        clinic: L(
            'צדוק רפואה משלימה · ירושלים',
            'Tzadok Complementary Medicine · Jerusalem',
        ),
        city: CITY.jerusalem,
        phone: '058-000-3311',
        email: 'avigail@tzadok-clinic.example',
        status: 'active',
        points: 640,
        disc: 40,
        orders: 71,
        ...
        tz: '963748291',
        // V2 — accounting & payment
        accountingEmail: 'accounts@lavi-books.example',
        bizNum: '816273849',
        payMethod: 'transfer',
        shelfDisc: 45,
    },
    {
        code: '11601',
        first: L('זוהר', 'Zohar'),
        last: L('נחמיאס', 'Nahmias'),
        therapy: 'aromatherapy',
        spec: SPEC.skin,
        clinic: L('הרמוניה · הרצליה', 'Harmonia · Herzliya'),
        city: CITY.herzliya,
        phone: '052-000-8877',
        email: 'zohar@harmonia.example',
        status: 'active',
        points: 0,
        disc: 40,
        orders: 12,
    ...
    },
    {
        code: '11622',
        first: L('כרמל', 'Carmel'),
        last: L('ויסמן', 'Weissman'),
        therapy: 'homeopathy',
        spec: SPEC.children,
        clinic: L('ויסמן · באר שבע', 'Weissman · Beer Sheva'),
        city: CITY.beerSheva,
        phone: '050-000-4412',
        email: 'carmel.w@mail.example',
        status: 'active',
        points: 210,
        disc: 40,
        orders: 39,
        ...
        tz: '985920138',
        // V2 — accounting & payment
        accountingEmail: 'hesh@adler-books.example',
        bizNum: '813948271',
        payMethod: 'transfer',
        shelfDisc: 40,
    },
    {
        code: '11640',
        first: L('רועי', 'Roi'),
        last: L('טולדנו', 'Toledano'),
        therapy: 'reflexology',
        spec: SPEC.mind,
        clinic: null,
        city: CITY.netanya,
        phone: '054-000-2200',
        email: 'roi.t@mail.example',
        status: 'active',
        points: 55,
        disc: 40,
        orders: 8,
    ...
    return [
        {
            ...
            cert: true,
            listed: true,
            clinicName: L('צמיחה · גבעתיים', 'Tzmiha · Givatayim'),
            clinicDesc: L(
        ...
        },
        {
            id: 'r2',
            first: L('בועז', 'Boaz'),
            last: L('אזולאי', 'Azoulay'),
            tz: '915849302',
            role: 'student',
            therapy: 'naturopathy',
            spec: SPEC.digestive,
            email: 'boaz.azoulay@mail.example',
            phone: '050-000-2277',
            city: CITY.rishon,
            street: STREET.allenby,
            num: '12',
            apt: '3',
            floor: '1',
            entry: null,
            college: L('רידמן', 'Reidman'),
            teacher: L('ד״ר גלית לביא', 'Dr. Galit Lavi'),
            head: L('רותם יהלום', 'Rotem Yahalom'),
            intern: true,
            cert: true,
            listed: false,
            submitted: at(0, 7, 2),
        ...
        },
        {
            ...
            cert: true,
            listed: true,
            clinicName: L('שביל · כפר סבא', 'Shvil · Kfar Saba'),
            clinicDesc: L(
        ...
        },
        {
            id: 'r4',
            first: L('הראל', 'Harel'),
            last: L('בן־ארי', 'Ben-Ari'),
            tz: '937061524',
            role: 'student',
            therapy: 'clinical_nutrition',
            spec: SPEC.immune,
            email: 'h.benari@mail.example',
            phone: '053-000-0028',
            city: CITY.haifa,
            street: STREET.carmel,
            num: '5',
            apt: '',
            floor: '',
            entry: null,
            ...
            teacher: L('דוד גרינברג', 'David Grinberg'),
            head: L('מרים זילבר', 'Miriam Zilber'),
            intern: false,
            cert: false,
            listed: false,
        ...
        },
        {
            ...
            therapy: 'aromatherapy',
            spec: SPEC.mind,
            email: 'ayala.haruti@mail.example',
            phone: '058-000-1123',
            city: CITY.telAviv,
            street: STREET.ahadHaam,
            num: '160',
            apt: '9',
            floor: '3',
            entry: null,
...
const PATIENT_NAMES = [
    [L('טל', 'Tal'), L('זילבר', 'Zilber')],
    [L('אסף', 'Asaf'), L('גרינברג', 'Grinberg')],
    [L('עדי', 'Adi'), L('לביא', 'Lavi')],
    [L('גלית', 'Galit'), L('יהלום', 'Yahalom')],
    [L('אבנר', 'Avner'), L('חרותי', 'Haruti')],
    [L('רותם', 'Rotem'), L('אדלר', 'Adler')],
    [L('תומר', 'Tomer'), L('בן־ארי', 'Ben-Ari')],
    [L('זהר', 'Zohar'), L('ליבנה', 'Livne')],
    [L('דורון', 'Doron'), L('ברקוביץ', 'Berkovich')],
    [L('מרים', 'Miriam'), L('סגל', 'Segal')],
    [L('הדר', 'Hadar'), L('כספי', 'Kaspi')],
    [L('שחר', 'Shahar'), L('פלד', 'Peled')],
];

const PATIENT_FACTS = [
    { tz: '912874905', phone: '052-000-9930', age: 42, sex: 'f', meds: [] },
    {
        tz: '927819034',
        phone: '054-000-2299',
        age: 61,
    ...
    { tz: '984019274', phone: '058-000-1145', age: 51, sex: 'f', meds: [] },
    {
        tz: '995128374',
        phone: '052-000-3320',
        age: 44,
    ...
    { tz: '906283719', phone: '053-000-8890', age: 26, sex: 'f', meds: [] },
    {
        tz: '917392846',
        phone: '054-000-2277',
        age: 63,
    ...
    { tz: '928401937', phone: '050-000-9911', age: 35, sex: 'm', meds: [] },
];
...
export function buildAdmins() {
    return [
        {
            id: 'a1',
            name: DEMO_ACTORS.orit,
            email: 'orit@trifolium.example',
            phone: '052-0001207',
            created: '2026-01-02',
            last: at(0, 8, 41),
            me: true,
        ...
        {
            id: 'a2',
            name: DEMO_ACTORS.amit,
            email: 'amit@trifolium.example',
            phone: '054-0002219',
            created: '2026-01-02',
            last: at(0, 9, 12),
            me: false,
        ...
        {
            id: 'a3',
            name: DEMO_ACTORS.nir,
            email: 'nir@trifolium.example',
            phone: '053-0004408',
            created: '2026-03-18',
            last: at(1, 17, 26),
            me: false,
        ...
        {
            id: 'a4',
            name: DEMO_ACTORS.ella,
            email: 'ella@trifolium.example',
            phone: '050-0005514',
            created: '2026-05-11',
            last: at(3, 12, 3),
            me: false,
...
export function buildCustomers(orders, practitioners) {
    return DEMO_PATIENTS.map((patient, i) => {
        ...
        return {
            ...
            tz: patient.tz,
            phone: patient.phone,
            email: `c${10240 + i * 13}@mail.example`,
            age: patient.age,
            sex: patient.sex,
            ...
            transfers:
                i === 2
                    ? [
                          {
                              fromCode: '11601',
                              fromName: L('זוהר נחמיאס', 'Zohar Nahmias'),
                              toCode: '11533',
                              toName: L('סיגל ארבל', 'Sigal Arbel'),
                              when: '2026-05-12',
                              by: DEMO_ACTORS.orit,
                              why: L(
