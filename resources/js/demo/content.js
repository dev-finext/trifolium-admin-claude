...
const AUTHOR = {
    tzadok: L('ד״ר אביגיל צדוק', 'Dr. Avigail Tzadok'),
    kaspi: L('פרופ׳ אבנר כספי', 'Prof. Avner Kaspi'),
    segev: L('גלית שגב', 'Galit Segev'),
    arbel: L('ד״ר עדי ארבל', 'Dr. Adi Arbel'),
    rosen: L('בועז רוזן', 'Boaz Rosen'),
};
...
export const DEMO_EVENTS = [
    {
        ...
        desc: L(
            'יום עיון מקצועי עם ד״ר אביגיל צדוק ועוד 12 מרצים מובילים בתחום.',
            'A professional study day with Dr. Avigail Tzadok and 12 other leading speakers.',
        ),
        date: '2026-06-12',
    },
    {
