...
export default {
    ...
    card: {
        ...
        batchesAll: '{n} אצוות בסך הכל · לחיצה מפרטת',
    ...
    editor: {
        ...
        group: 'קטגוריה',
        nameForeign: 'שם סיני',
        nameForeignHint: 'הפין-יין, כפי שהוא בסאפ. מלא בכמחצית מהפריטים.',
        nameHeHint:
            'השם כפי שהוא בסאפ. בפריטים שאינם צמחים — אריזות, פקקים, מדבקות ותרופות — זהו השם בעברית.',
        uomGroup: 'קבוצת יחידות מידה',
        barcode: 'ברקוד',
        additionalId: 'מזהה נוסף',
        frozen: 'מוקפא',
