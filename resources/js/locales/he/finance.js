...
export default {
    ...
    reconcile: {
        intro: 'רק המערכת רואה גם את הסליקה וגם את ספק המסמכים — לכן רק כאן אפשר לענות על שלוש השאלות האלה. בסוף כל חודש שלוש הטבלאות אמורות להיות ריקות.',
        paidTitle: 'הזמנות ששולמו ואין להן מסמך',
        paidEmpty: 'לכל הזמנה ששולמה יש מסמך',
        orphansTitle: 'מסמכים שאין מאחוריהם הזמנה',
        orphansEmpty: 'לכל מסמך יש הזמנה',
        mismatchTitle: 'מסמכים שהסכום שלהם שונה מההזמנות שהם מכסים',
        mismatchEmpty: 'כל המסמכים מסתכמים להזמנות שלהם',
        kpi: {
            paid: 'שולם בלי מסמך',
            paidSub: 'הזמנות',
            orphans: 'מסמך בלי הזמנה',
            orphansSub: 'מסמכים',
            mismatch: 'פער סכום',
            mismatchSub: 'מסמכים',
        },
    ...
    preview: {
        num: 'מספר מסמך',
        noNum: 'טרם הופק',
        allocation: 'מספר הקצאה',
        when: 'תאריך',
        to: 'לקוח',
        terminal: 'מסוף',
        pdf: 'PDF',
        markSent: 'סימון נשלח להנה״ח',
        sentOn: 'נשלח להנהלת חשבונות {when}',
        sentToast: 'המסמך סומן כנשלח להנהלת חשבונות',
        lines: 'שורות המסמך',
        subtotal: 'סה״כ שורות',
        discount: 'הנחה',
        points: 'נקודות',
