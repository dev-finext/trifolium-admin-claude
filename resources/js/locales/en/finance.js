...
export default {
    ...
    reconcile: {
        intro: 'Only this console sees both the card processor and the document provider, so only here can these three questions be answered. At month end all three tables should be empty.',
        paidTitle: 'Paid orders without a document',
        paidEmpty: 'Every paid order has a document',
        orphansTitle: 'Documents with no order behind them',
        orphansEmpty: 'Every document has an order',
        mismatchTitle:
            'Documents whose total differs from the orders they cover',
        mismatchEmpty: 'Every document adds up to its orders',
        kpi: {
            paid: 'Paid without a document',
            paidSub: 'orders',
            orphans: 'Document without an order',
            orphansSub: 'documents',
            mismatch: 'Amount mismatch',
            mismatchSub: 'documents',
        },
        col: {
            who: 'Customer',
            when: 'Date',
            ...
            orders: 'Orders',
            expected: 'Orders total',
            documented: 'On the document',
            diff: 'Difference',
        },
    },
    ...
    preview: {
        ...
        sentOn: 'Sent to accounting {when}',
        sentToast: 'Document marked as sent to accounting',
        ...
        // config/finance.js DOC_LINE_KIND_IDS
        kind: {
            component: 'Component',
            shelf: 'Shelf product',
            shipping: 'Shipping',
