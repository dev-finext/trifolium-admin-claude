...
const ENUM_NAMESPACES = [
    ...
    ['@/config/items', 'COMPONENT_WAREHOUSE_IDS', 'items.componentWarehouse'],
    ['@/config/items', 'ISSUE_METHOD_IDS', 'items.issueMethod'],
    ['@/config/items', 'ITEM_TYPE_IDS', 'items.itemType'],
    ['@/config/items', 'PLANNING_METHOD_IDS', 'items.planningMethod'],
    ['@/config/items', 'PROCUREMENT_METHOD_IDS', 'items.procurementMethod'],
    ['@/config/items', 'VALUATION_METHOD_IDS', 'items.valuation'],
    ...
    ['@/config/items', 'TREE_TYPE_IDS', 'items.treeType'],
